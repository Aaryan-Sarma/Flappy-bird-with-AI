...
#floor options
floor_velocity = 10 #the horizontal moving velocity of the floor, this should equal to pipe_velocity
...
pipe_velocity = 10 #the horizontal moving velocity of the pipes, this should equal to floor_velocity
...
def draw_game(screen, birds, pipes, floor, score, generation, game_time):
    ...
    screen.blit(game_time_text,
                (SCREEN_WIDTH - 15 - game_time_text.get_width(), 15 + score_text.get_height()))  # draw the progress
    ...
    progress_text = FONT.render('Pipes Remaining: ' + str(len(pipes) - score), 1,
                                FONT_COLOR)  # set up the text to show the progress
